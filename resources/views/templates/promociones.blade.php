...
<div id="promo-sae-banco">
        <section class="promos-banner">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <img src="/images-new/inelco/otros/inelco-promos-aspel-sae-banco_3.png" alt="" class="center-block">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-5">
                        <img src="/images-new/inelco/otros/inelco-promos-aspel-sae-banco-mayo_2.png" alt="" class="img-responsive precio-banner">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 beneficios-ul">
                        ...
                        <ul>
                            <li>Genera automáticamente los cargos o los cheques programados para el pago a proveedores.</li>
                            <li>Actualiza en línea los saldos de todas las operaciones de cuentas por cobrar y por pagar.</li>
                            <li>Registra en un solo paso anticipos de clientes o proveedores mediante la captura masiva.</li>
                            <li>Lleva el control de los tipos de cambio al elegir la moneda a utilizar por cuenta bancaria y movimiento.</li>
                            <li>Asocia y consulta cualquier archivo por cada operación incluyendo comprobantes fiscales digitales CFDI 3.3.</li>
                        </ul>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 incluye-promo">
                        <div class="col-sm-12 ">
                            <p><span id="title-incluye-promo">El combo Aspel SAE+BANCO incluye:</span></p>
                        </div>
                        <div class="col-sm-12">
                        ...
                        <div class="col-sm-12">
                            <p><span class="glyphicon glyphicon-ok"></span> Cupón de 20% en curso Aspel SAE y Aspel BANCO</p>
                        </div>
                        <div class="col-sm-12">
                            <p><span class="glyphicon glyphicon-ok"></span> Cupón de 20% en póliza</p>
                        </div>
                        <div class="col-sm-12" style="margin-top: 28px">
                            <a href='https://survey.zohopublic.com/zs/csB0HW' title='' target='_blank' onclick='zs_open_window(this.href, 648, 700); return false;' class="text-center center-block p-contacto-title" style="text-decoration: none" >
                    ...
                    <div class="col-md-6">
                        <p align="center">
                            <img src="/images-new/inelco/otros/inelco-promos-aspel-sae-banco-mayo_2.png" alt="" class="img-responsive">
                        </p>
                    </div>
                </div>
                <div class="promo-25">
...
{{--                             <a style="text-decoration: none" href="https://survey.zohopublic.com/zs/lIB5ob" target="_blank" class="text-center center-block p-contacto-title">
                            ...
                            <a href='https://survey.zohopublic.com/zs/lIB5ob' title='' target='_blank' onclick='zs_open_window(this.href, 648, 700); return false;' class="text-center center-block p-contacto-title" style="text-decoration: none" >
                                <button class="btn btn-promo btn-lg">
                                    Contratar ahora
                                </button>
                            </a>
            ...
            <div class="row">
                <div class="col-md-5">
                    <p id="terminos">
                        Terminos y condiciones: Precios en MXN + IVA. No incluye servicio de implementación. Precio por sólo un usuario. El costo por usuario adicional varia. Promoción vigente hasta 30 de junio 2018.
                    </p>
                </div>
            </div>
        </section>
