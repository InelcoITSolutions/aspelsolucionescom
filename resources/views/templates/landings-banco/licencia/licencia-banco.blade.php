@extends('templates.landings-banco.principal')
    ...
    <div class="container">
        ...
        <div class="row frase-de-impacto wow fadeInDown" data-wow-delay="0.5s">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 img-left">
                <img alt="aspel banco" class="img-responsive" src="/img/img-landings-sae/aspelsoluciones-sae70.png" width="400">
                </img>
            </div>
        </div>
...
<section class="secciones-noi par-nuevo" id="lo-nuevo">
    <div class="container">
        ...
        <div class="logo-producto">
            <img alt="Logo Aspel banco" class="center-block fadeInDown" data-wow-delay="0.5s" src="/images-new/marcas/aspel/productos/banco/logos/inelco-aspel-banco-logo.png"  style="width: 200px;height: 200px;">
                </img>
        </div>
            ...
            <div class="row fila2">
                ...
                <div class="col-md-4">
                    <div align="center" class="imagen">
                        <img alt="Logo Aspel-SAE" class="img-responsive" style="width: 250px;height: 250px;" src="/images-new/marcas/aspel/productos/banco/logos/inelco-aspel-banco-logo.png">
                        </img>
                    </div>
            ...
            <div class="row fila3">
                ...
                <div class="col-md-4 text-left wow bounceInRight" data-wow-delay="0.5s">
                    ...
                    <div class="body-dos">
                        ...
                        <br/>
                        Aspel banco tiene interfaz con los Sistemas: 
