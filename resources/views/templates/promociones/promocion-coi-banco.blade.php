@extends('templates.landings-promociones.principal-coi-banco')
    ...
    <div id="promo-coi-banco">
        ...
        <section class="promo-contacto">
            ...
            <div class="row">
                <div class="col-md-5">
                    <p id="terminos">
                        *Terminos y condiciones: Precios en MXN + IVA. No incluye servicios. Precio de lista: $10,357 MXN + IVA. Promoción vigente hasta el 31 de julio 2018.
                    </p>
                </div>
            </div>
        </section>
