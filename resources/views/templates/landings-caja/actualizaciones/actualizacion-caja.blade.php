@extends('templates.landings-caja.principal')
@section('title','Actualización Aspel CAJA 4.0')
@push('css-promocion-nuevo-noi')

<link href="/css/landings-CAJA/estilos-CAJA.css" rel="stylesheet" type="text/css"/>
<link href="/css/landings-CAJA/form-promocion.css" rel="stylesheet"/>
            ...
            <div class="row fila2">
                ...
                <div class="col-md-4">
                    <div align="center" class="imagen">
                        <img alt="logo COI" class="img-responsive" height="250" src="/img/aspel-CAJA.png" width="250">
                        </img>
                    </div>
        ...
        <div class="row">
            <center>
                <div class="col-md-4 img-derecha wow fadeInLeft" data-wow-delay="0.5s">
                    <img alt="caracteristicas coi" class="img-responsive img-center" src="/img/aspel-CAJA.png" width="250">
                    </img>
                </div>
            </center>
