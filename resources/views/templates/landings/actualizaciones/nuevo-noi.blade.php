...
@section('title','Actualización Aspel NOI 8.0')
    ...
    <div class="container">
        ...
        <div class="row wow fadeInDown" data-wow-delay="0.5s">
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 izquierda">
                <img alt="Actualizacion NOI" class="img-responsive" src="/img/img-landings/aspelsoluciones_noi8_promoactualizacion_14noviembre.png" width="400">
                </img>
            </div>
    ...
    <div class="container">
        <div class="row titulo wow bounceIn" data-wow-delay="0.5s">
            <h2 class="text-center">
                ¿Tienes alguna versión anterior de Aspel NOI?
            </h2>
        ...
        <div class="row">
            <div class="col-md-6 form-promocion form-abajo">
                ...
                @include('partials.form-promocion')
            </div>
            <div class="col-md-6 ocultar img-arriba wow bounceIn" data-wow-delay="0.5s">
                <img alt="Actualizacion NOI" class="img-responsive" src="/img/img-landings/aspelsoluciones_noi8_promoactualizacion_14noviembre.png" width="600">
                </img>
            </div>
        </div>
        <div class="col-md-5">
        </div>
        <div class="col-md-7 nota ocultar wow fadeInDown" data-wow-delay="0.5s">
            <p>
                Promoción incluye:
                <br>
                    1 Licencia electrónica de Actualización Aspel NOI 8.0 (1usuario / 99 empresas) PL $3,530*
                    <br>
        ...
        <!-- 
        <div class="row">
            @foreach($productos_nuevos1 as $productos_noi)
            <div align="center" class="boton wow bounceIn" data-wow-delay="0.5s">
                <a class="button large radius goContrata" href="{{route('añadir-pedido',$productos_noi->tipo)}}">
                    COMPRAR AHORA
                </a>
            </div>
            @endforeach
                ...
                <div class="price-block agile">
                    ...
                    <div class="incluye">
                        ...
                        <ul>
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <s>
                                            Precio regular: $ {{$productos_noi->precio_incluye1}}
                                        </s>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <s>
                                            Precio regular: $ {{$productos_noi->precio_incluye2}}
                                        </s>
                                    </li>
                                </ul>
                            </li>
                        ...
                        <span style="visibility: hidden;">
                            {{$a= $productos_noi->precio_incluye1 - $productos_noi->precio}}
                            {{$b= $a + $productos_noi->precio_incluye2}}
                        </span>
