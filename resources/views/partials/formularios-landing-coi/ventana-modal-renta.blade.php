...
<div class="modal fade" id="login-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            ...
            <form id="login-form" action='https://crm.zoho.com/crm/WebToLeadForm' name=WebToLeads2073942000002836013 method='POST' onSubmit='javascript:document.charset="UTF-8"; return checkMandatory()' accept-charset='UTF-8'>
                <div class="modal-header" align="center">
                    <img class="img-circle" id="img_logo" src="/img/img-landings-coi/aspel-COI-formulario.png">
                ...
                <div id="div-forms crmWebToEntityForm">
                    ...
                    <input type='text' style='display:none;' name='xmIwtLD' value='cd8a13ffaae3a66c0d142196633534a5ee438c6f5b8d01cbd6e82c6be7915e0b'/>
                    <input type='text' style='display:none;'  name='actionType' value='TGVhZHM='/>

                    <input type='text' style='display:none;' name='returnURL' value='https&#x3a;&#x2f;&#x2f;www.aspelsoluciones.com&#x2f;nuevo-coi' /> 
                     <!-- Do not remove this code. -->
                     ...
                     <!-- Do not remove this code. -->
                        <div class="modal-body">
                            <div id="div-login-msg">
                                ...
                                <span id="text-login-msg">Suscripción mensual</span>
                            </div>
                            <!-- nombre-->
  ...
  <tr style='display:none;' ><td style='nowrap:nowrap;text-align:left;font-size:12px;font-family:Arial;width:50%'>Fuente de Posible cliente</td><td style='width:250px;'>
    ...
    <option selected value='AS&#x20;COI&#x20;RENTA'>AS COI RENTA</option>
    </select></td></tr>
  ...
  <script>
    ...
    for(i=0;i<mndFileds.length;i++) {
      var fieldObj=document.forms['WebToLeads2073942000002836013'][mndFileds[i]];
      if(fieldObj) {
...
<script type='text/javascript' id='VisitorTracking'>var $zoho= $zoho || {salesiq:{values:{},ready:function(){$zoho.salesiq.floatbutton.visible('hide');}}};var d=document;s=d.createElement('script');s.type='text/javascript';s.defer=true;s.src='https://salesiq.zoho.com/ventassyca/float.ls?embedname=ventassyca';t=d.getElementsByTagName('script')[0];t.parentNode.insertBefore(s,t);function trackVisitor(){try{if($zoho){var LDTuvidObj = document.forms['WebToLeads2073942000002836013']['LDTuvid'];if(LDTuvidObj){LDTuvidObj.value = $zoho.salesiq.visitor.uniqueid();}var firstnameObj = document.forms['WebToLeads2073942000002836013']['First Name'];if(firstnameObj){name = firstnameObj.value +' '+name;}$zoho.salesiq.visitor.name(name);var emailObj = document.forms['WebToLeads2073942000002836013']['Email'];if(emailObj){email = emailObj.value;$zoho.salesiq.visitor.email(email);}}} catch(e){}}</script>
