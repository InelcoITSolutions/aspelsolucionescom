...
<div class="modal fade" id="licencia-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            ...
            <META HTTP-EQUIV ='content-type' CONTENT='text/html;charset=UTF-8'>
                    <form id="login-form" action='https://crm.zoho.com/crm/WebToLeadForm' name=WebToLeads2073942000002836020 method='POST' onSubmit='javascript:document.charset="UTF-8"; return checkMandatory1()' accept-charset='UTF-8'>
  ...
  <input type='text' style='display:none;' name='xmIwtLD' value='cd8a13ffaae3a66c0d142196633534a58f29710034fe1ba4f5d676d1e2c4e0a1'/>
  ...
  <tr style='display:none;' ><td style='nowrap:nowrap;text-align:left;font-size:12px;font-family:Arial;width:50%'>Fuente de Posible cliente</td><td style='width:250px;'>
    ...
    <option selected value='AS&#x20;COI&#x20;COMPRA'>AS COI COMPRA</option>
  ...
  <script>
    ...
    for(i=0;i<mndFileds.length;i++) {
      var fieldObj=document.forms['WebToLeads2073942000002836020'][mndFileds[i]];
      if(fieldObj) {
...
<script type='text/javascript' id='VisitorTracking'>var $zoho= $zoho || {salesiq:{values:{},ready:function(){$zoho.salesiq.floatbutton.visible('hide');}}};var d=document;s=d.createElement('script');s.type='text/javascript';s.defer=true;s.src='https://salesiq.zoho.com/ventassyca/float.ls?embedname=ventassyca';t=d.getElementsByTagName('script')[0];t.parentNode.insertBefore(s,t);function trackVisitor(){try{if($zoho){var LDTuvidObj = document.forms['WebToLeads2073942000002836020']['LDTuvid'];if(LDTuvidObj){LDTuvidObj.value = $zoho.salesiq.visitor.uniqueid();}var firstnameObj = document.forms['WebToLeads2073942000002836020']['First Name'];if(firstnameObj){name = firstnameObj.value +' '+name;}$zoho.salesiq.visitor.name(name);var emailObj = document.forms['WebToLeads2073942000002836020']['Email'];if(emailObj){email = emailObj.value;$zoho.salesiq.visitor.email(email);}}} catch(e){}}</script>
