...
<div class="modal fade" id="actualizacion-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            ...
            <META HTTP-EQUIV ='content-type' CONTENT='text/html;charset=UTF-8'>
                    <form id="login-form" action='https://crm.zoho.com/crm/WebToLeadForm' name=WebToLeads2073942000002836006 method='POST' onSubmit='javascript:document.charset="UTF-8"; return checkMandatory2()' accept-charset='UTF-8'>
                ...
                <div id="div-forms crmWebToEntityForm">
                    ...
                    <!-- Do not remove this code. -->
                        ...
                        <input type='text' style='display:none;' name='xmIwtLD' value='cd8a13ffaae3a66c0d142196633534a5c16bc4a13725973d73719e4a74bc20c3'/>
                        ...
                        <table>
                            ...
                            <option selected value='AS&#x20;SAE&#x20;ACTUALIZACION'>AS SAE ACTUALIZACION</option>
                            </select>
                            </td></tr>
                        </table>
    ...
    for(i=0;i<mndFileds.length;i++) {
      var fieldObj=document.forms['WebToLeads2073942000002836006'][mndFileds[i]];
      if(fieldObj) {
