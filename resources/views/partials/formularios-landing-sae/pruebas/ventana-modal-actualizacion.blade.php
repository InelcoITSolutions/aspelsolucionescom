...
<div class="modal fade" id="login-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            ...
            <META HTTP-EQUIV ='content-type' CONTENT='text/html;charset=UTF-8'>
                    <form id="login-form" action='https://crm.zoho.com/crm/WebToLeadForm' name=WebToLeads2073942000002818015 method='POST' onSubmit='javascript:document.charset="UTF-8"; return checkMandatory2()' accept-charset='UTF-8'>
                ...
                <div id="div-forms crmWebToEntityForm">
                    ...
                    <input type='text' style='display:none;' name='xmIwtLD' value='cd8a13ffaae3a66c0d142196633534a5be602a101a8898b81947c601461db401'/>
                    ...
                    <input type='text' style='display:none;' id='LDTuvid' name='LDTuvid'></input>
                        ...
                        <div class="modal-body">
                            <div id="div-login-msg">
                                ...
                                <span id="text-login-msg">Suscripcion mensual</span>
                            </div>
                      ...
                      <table>
                        ...
                        <td style='nowrap:nowrap;text-align:left;font-size:12px;font-family:Arial;width:50%'>Fuente de Posible cliente</td>
                        <td style='width:250px;'>
                          <select style='width:250px;' name='Lead Source'>
                          <option selected value='AS&#x20;SAE&#x20;RENTA'>AS SAE RENTA</option>
                          </select>
                        </td>
                        </tr>
                      </table>
    ...
    for(i=0;i<mndFileds.length;i++) {
      var fieldObj=document.forms['WebToLeads2073942000002818015'][mndFileds[i]];
      if(fieldObj) {
