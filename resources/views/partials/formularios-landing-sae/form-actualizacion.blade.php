...
<div class="formulario-center" id="registro">
    <center>
        <form action="{{url('actualizacion-sae')}}" class="form-horizontal" id="form1" method="POST" role="form">
            {{csrf_field()}}
            <div class="col-sm-12">
            ...
            <div class="col-sm-12">
                <input id="interesado" name="interesado" style="display: none; visibility: hidden;" type="text" value="Actualización Nuevo SAE"/>
            </div>
...
{{--         <div align="left" class="col-sm-12">
            ...
            <div class="g-recaptcha" data-sitekey="6LchTVcUAAAAAPLghiRU-48nojAlgdxXgHo--EFH"></div> --}}

            <div align="left" class="col-sm-12" style="top:16px;">
                <center>
