    ...
    <div class="container">
        ...
        <div class="row">
            @if(count($errors)>0)
                ...
                @endif
                {!! Form::open(['action' => 'Admin\ProductoController@store','class'=>'form-horizontal']) !!}
            <div class="col-md-6">
                <div class="mdb-select">
                    {!! Form::label('categoria_id', 'Categoria')!!}
                        {!!Form::select('categoria_id',$categorias,null, ['class'=>'form-control','required' => 'required','autofocus' => 'autofocus','placeholder' => '--Selecciona categoria--','style'=>"padding: .2rem 0 .6rem;"])!!}
                </div>
                <div class="md-form">
            ...
            <div class="col-md-6">
                ...
                <fieldset class="form-group">
                    {!!Form::checkbox('visible',null,['required' => 'required'])              
                        !!}
