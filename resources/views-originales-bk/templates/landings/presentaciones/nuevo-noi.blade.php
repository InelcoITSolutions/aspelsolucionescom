...
@section('title','Presentacion Aspel NOI 8.0')
@push('css-presentacion-nuevo-noi')
<link href="/css/landings/presentacion-nuevo-noi.css" rel="stylesheet" type="text/css"/>
...
<section class="secciones-noi" id="inicio-aspel-noi">
    <div class="container">
        ...
        <div class="row frase-de-impacto">
            <div class="col-md-6">
                <h1 class="frase">
                    <i>
                        Descubre el nuevo
        ...
        <div class="row">
            <div align="right" class="boton">
                <a class="button large radius goContrata ancla2" href="#registrarme">
                    Conocelo ahora
                </a>
            </div>
        </div>
