...
@section('title','Soluciones ADM Tienda')
@push('add-css')
...
<!-- aqui empieza el contenido -->
    <section class="secciones admtienda-pages soluciones-admtienda" id="notas">  
        <div class="container">
            ...
            <h3 class="title-h3">Con ADM Tienda generas notas de venta en segundos, imprímelas y envíalas por correo electrónico a tus clientes.</h3>
             ...
             <div class="row">                
                <div class="col-md-6">  
                       <ul>
                       <li><i aria-hidden="true" class="fa fa-angle-right">
                        </i> Genera las notas de venta desde tu tablet de manera rápida y sencilla.</li>
                        <li> <i aria-hidden="true" class="fa fa-angle-right">
                        </i>Envía el ticket por correo electrónico o imprímelo.</li>
                        <li> <i aria-hidden="true" class="fa fa-angle-right">
                        </i> Emite la factura al momento del cobro o a través del portal de facturación.</li>
                    </ul>
                </div>
            
            <div class="col-md-6 imagencontainer">
                    <img src="/img/productos/ADMTienda/soluciones/Inelco-adm-tienda-soluciones-notas-venta.png" alt="inventario y servicios" class="img-responsive ">                    
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="secciones  admtienda-pages soluciones-admtienda" id="clientes">
        <div class="container">
            ...
            <div class="row"> 
            <div class="col-md-6 imagencontainer">
                    <img src="/img/productos/ADMTienda/soluciones/Inelco-adm-tienda-soluciones-clientes.png" alt="inventario y servicios" class="img-responsive ">                    
            </div>
                <div class="col-md-6">  
    ...
    <section class="secciones  admtienda-pages soluciones-admtienda" id="productos">
        <div class="container">
            ...
            <div class="row">                
                ...
                <div class="col-md-6 imagencontainer">
                    <img src="/img/productos/ADMTienda/soluciones/Inelco-adm-tienda-soluciones-productos.png" alt="inventario y servicios" class="img-responsive ">                    
                </div>
            </div>
    ...
    <section class="secciones  admtienda-pages soluciones-admtienda" id="movimiento">
        <div class="container">
            ...
            <div class="row">   
                <div class="col-md-6 imagencontainer">
                    <img src="/img/productos/ADMTienda/soluciones/Inelco-adm-tienda-soluciones-arqueo-caja.png" alt="inventario y servicios" class="img-responsive ">                    
                </div>
            ...
            <div class="row">   
                ...
                <div class="col-md-6 imagencontainer">
                    <img src="/img/productos/ADMTienda/soluciones/Inelco-adm-tienda-soluciones-movimiento-caja.png" alt="inventario y servicios" class="img-responsive ">                    
                </div>
    ...
    <section class="secciones  admtienda-pages soluciones-admtienda" id="administra">
         <div class="container">
            ...
            <div class="row">                
                ...
                <div class="col-md-6 imagencontainer">
                    <img src="/img/productos/ADMTienda/soluciones/Inelco-adm-tienda-soluciones-cajeros.png" alt="inventario y servicios" class="img-responsive ">                    
                </div>
            </div>
     ...
     <section class="secciones  admtienda-pages soluciones-admtienda" id="mas">
        <div class="container">
            ...
            <div class="row">   
                <div class="col-md-6 imagencontainer">
                    <img src="/img/productos/ADMTienda/soluciones/lnelco-adm-tienda-soluciones-estadisticas.png" alt="inventario y servicios" class="img-responsive ">                    
                </div>
            ...
            <br>
                <div class="col-md-6 imagencontainer">
                    <img src="/img/productos/ADMTienda/soluciones/Inelco-adm-tienda-soluciones-integra-adm.png" alt="inventario y servicios" class="img-responsive ">                    
                </div>
