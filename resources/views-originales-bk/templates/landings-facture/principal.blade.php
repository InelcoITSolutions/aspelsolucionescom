...
<html lang="es-MX">
    <head>
        ...
        <link href="/img/aspel-FACTURE.png" rel="icon" type="image/png"/>
        
        <title>
            Aspel Soluciones | @yield('title')
        </title>

        <meta content="El Sistema es ideal para emprendedores y profesionistas que facturan servicios. " name="description"/>
        ...
        <link href="/css/landings-FACTURE/footer-FACTURE.css" rel="stylesheet"/>
    ...
    <body>
        ...
        @section('footer')
            @include('partials.footer.footer-landings-FACTURE')           
        @show
        {{--boton de ir arriba--}}
