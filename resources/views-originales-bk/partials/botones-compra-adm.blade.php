    ...
    <div class="fondo-morado">
        <div class="container">
            <h2 class="text-center wow fadeInDown" data-wow-delay="0.5s">
                Aspel ADM revoluciona el control administrativo
            </h2>
            <p class="text-center wow fadeInDown" data-wow-delay="0.5s">
                Todas las Funciones para Administrar, Controlar y Crecer tu Pyme.
            </p>
                {{-- 
            <p class="text-center wow fadeInDown" data-wow-delay="0.5s">
                La herramienta ideal para pequeños empresarios, emprendedores y startups que deseen consolidar el crecimiento de su negocio
            </p>
                --}}
            {{--
            ...
            <div class="row">
                <div align="center" class="col-xs-12 col-sm-12 col-md-12">
                    <div class="boton wow fadeInDown" data-wow-delay="0.5s">
                        <a class="button-gratis-adm large radius goContrata ancla2" 
                        href="{{url('contacto')}}">
                ...
                <div align="center" class="col-xs-6 col-sm-6 col-md-6">
                    <div class="boton wow fadeInDown" data-wow-delay="0.5s">
                        <a class="button-gratis-adm large radius goContrata ancla2" data-target="#suscripcion" data-toggle="modal">
                            Suscribirse ahora
                        </a>
                    </div>
                </div>
