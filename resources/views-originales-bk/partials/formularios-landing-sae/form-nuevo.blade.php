...
<div class="formulario-center" id="registro">
    <center>
        <form action="{{url('nuevo-sae')}}" class="form-horizontal" id="form1" method="POST" role="form">
            {{csrf_field()}}
            <div class="col-sm-12">
            ...
            <div class="col-sm-12">
                <input id="interesado" name="interesado" style="display: none; visibility: hidden;" type="text" value="Nueva Licencia Nuevo SAE"/>
            </div>
