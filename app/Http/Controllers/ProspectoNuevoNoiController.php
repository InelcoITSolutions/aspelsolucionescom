...
class ProspectoNuevoNoiController extends Controller
{
    public function index()
    {
        return view('templates.landings.licencia-nueva.nuevo-noi');

    }
    public function create()
    {
        return redirect('nuevo-noi#adquirir');
    }
    ...
    public function store(Request $request)
    {
        ...
        Mail::send('templates.landings.correos.aviso-prospectos', $request->all(), function ($message) use ($request) {
            ...
            //asunto
            $message->subject('Adquirir Licencia Nueva de NOI');
        ...
        return redirect('nuevo-noi')->with('mensaje', 'Su registro se ha realizado de manera exitosa');
    }
}
