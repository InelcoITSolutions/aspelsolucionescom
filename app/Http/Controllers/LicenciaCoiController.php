...
class LicenciaCoiController extends Controller
{
    public function index()
    {
        ...
        return view('templates.landings-coi.licencia.licencia-coi', compact('productos_nuevos1'));
    ...
    {
        return redirect('nuevo-coi#adquirir');
    }
    ...
    public function store(Request $request)
    {
        ...
        Mail::send('templates.landings.correos.aviso-prospectos', $request->all(), function ($message) use ($request) {
            ...
            //asunto
            $message->subject('Nueva Licencia Nuevo COI');
        ...
        return redirect('nuevo-coi')->with('mensaje', 'Su registro a cotización se ha realizado de manera exitosa');
    }
}
