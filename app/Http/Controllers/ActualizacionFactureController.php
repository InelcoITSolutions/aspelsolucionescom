...
class ActualizacionFactureController extends Controller
{
    public function index()
    {
        ...
        return view('templates.landings-facture.actualizaciones.actualizacion-facture', compact('productos_nuevos1'));
    ...
    {
        return redirect('actualizacion-facture#adquirir');
    }
    ...
    public function store(Request $request)
    {
        ...
        Mail::send('templates.landings.correos.aviso-prospectos', $request->all(), function ($message) use ($request) {
            ...
            //asunto
            $message->subject('Actualización Nuevo FACTURE');
        ...
        return redirect('actualizacion-facture')->with('mensaje', 'Su registro se ha realizado de manera exitosa');
    }
}
